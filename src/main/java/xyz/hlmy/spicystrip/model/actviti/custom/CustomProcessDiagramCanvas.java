package xyz.hlmy.spicystrip.model.actviti.custom;
...
public class CustomProcessDiagramCanvas {
    ...
    public void drawExpandedSubProcess(String id, String name, GraphicInfo graphicInfo, Class<?> type) {
        ...
        if (type.equals(EventSubProcess.class)) {
            ...
            RoundRectangle2D outerRect = new RoundRectangle2D.Double(graphicInfo.getX() - 3, graphicInfo.getY() - 3, graphicInfo.getWidth() + 6, graphicInfo.getHeight() + 6, 8, 8);
